...
// = Plugin Name =
// ===============
define( 'CALP_PLUGIN_NAME',      'calpress-event-calendar' );
...
define( 'CALP_THEME_TRANSFER',          true );
if ( is_dir( $upload_dir['basedir'] . '/calpress-themes' ) ) {
    define( 'CALP_THEME_URL',        $upload_dir['baseurl'] . '/calpress-themes/' );
} else {
...
// = API SITE URL ===
// ==============
define( 'CALP_API_SITE_URL',   'http://www.calpresspro.com/' );
